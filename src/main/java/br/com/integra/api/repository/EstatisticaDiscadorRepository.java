...
public class EstatisticaDiscadorRepository {
	...
	public List<EstatisticaDiscador> findtipoEstatisticaTotalizadorDia(LocalDate date, String tipoEstatistica,
			EstatisticaFilter filter) {
	...
	public List<EstatisticaDiscador> findtipoEstatisticaTotalizadorDia(LocalDate date, String tipoEstatistica,
			EstatisticaFilter filter, Integer segundoInicial, Integer segundoFinal) {
		String dataFormatada = formatarData(date);
		...
		if ((tipoEstatistica.equals("chamada_com_segundo_desc_origem")
				|| tipoEstatistica.equals("chamada_com_segundo_desc_destino")) && segundoInicial != null
				&& segundoFinal != null) {
			sql = sql + String.format(" and CAST(tipoEstatiscaValor AS unsigned integer) BETWEEN %d and %d",
