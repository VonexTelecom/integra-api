...
public class CustomListChamadasDiscadasSerializer extends JsonSerializer<List<EstatisticaDiscador>>
{
    ...
    public void serialize(List<EstatisticaDiscador> value, JsonGenerator jgen,
        ...
        value.stream().filter(e -> e.getTipoEstatistica().equals("chamadas_discadas"))
        	.forEach(x -> {
        		 try {
